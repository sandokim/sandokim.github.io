...
## `feateaures = concat([features_dc, features_rest], dim=1)` # (n_points, RGB, max_degree_sh 계수)
...
- `features_dc # (n_points, RGB, 0)`
- `features_rest # (n_points, RGB, 1~44)`
- `featrues_dc`와 `features_rest`를 **RGB 차원으로 concat** 합니다.
...
[image](https://github.com/sandokim/sandokim.github.io/assets/74639652/926ec0aa-0eb5-4b43-abd9-d1d6b5c19508)
