...
- 자세한 내용은 [글쓴이 본인이 작성한 barycentric coordinates 포스트](https://sandokim.github.io/%EC%97%B0%EA%B5%AC/SuGaR-sugar-model-extract-texture-image-and-uv-from-gaussians/)를 참고하세요.
